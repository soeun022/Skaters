function startApp() {
    ...
    function scrollToAdjacentMonth(direction) {
        ...
        let currentIndex = blocks.findIndex(b => parseInt(b.dataset.year, 10) === currentYear && parseInt(b.dataset.month, 10) === currentMonth);
    ...
    function createDayCell(dayNumber, isOtherMonth, year, month) {
        ...
        visibleSchedules.forEach(({ schedule, match }) => {
            ...
            item.style.setProperty('--item-bg', colors.bg);
